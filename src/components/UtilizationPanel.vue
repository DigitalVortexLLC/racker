<template>
  ...
  >
    ...
    <!-- Expandable Content -->
    <div v-show="isExpanded" class="px-4 pb-4 border-t border-base-300">
      <!-- Power Utilization -->
      <div class="mb-4">
        ...
        <progress class="progress" :class="powerBarColor" :value="powerPercentage" max="100"></progress>
        <div class="text-xs mt-1 opacity-70">{{ powerPercentage }}%</div>
      </div>
      ...
      <div v-if="powerPortsCapacity > 0" class="mb-4">
        ...
        <progress class="progress" :class="powerPortsBarColor" :value="powerPortsPercentage" max="100"></progress>
        <div class="text-xs mt-1 opacity-70">{{ powerPortsPercentage }}%</div>
      </div>
      ...
      <div class="mb-4">
        ...
        <progress class="progress" :class="hvacBarColor" :value="hvacPercentage" max="100"></progress>
        <div class="text-xs mt-1 opacity-70">{{ hvacPercentage }}%</div>
      </div>
      ...
      <div>
        ...
        <progress class="progress" :class="ruBarColor" :value="ruPercentage" max="100"></progress>
        <div class="text-xs mt-1 opacity-70">{{ ruPercentage }}%</div>
      </div>

      <!-- Details Button -->
      <div class="mt-4">
        <button @click.stop="showDetailModal = true" class="btn btn-block btn-sm">
          View Details
        </button>
      </div>
    </div>
    ...
    <div v-show="!isExpanded" class="px-4 pb-4 flex flex-col gap-3">
      <!-- Power Compact -->
      <div class="tooltip tooltip-left" data-tip="Power">
        <div class="flex items-center gap-2">
          <div class="flex items-center gap-1.5">
            <svg class="size-5" fill="currentColor" viewBox="0 0 20 20">
              <path fill-rule="evenodd" d="M11.3 1.046A1 1 0 0112 2v5h4a1 1 0 01.82 1.573l-7 10A1 1 0 018 18v-5H4a1 1 0 01-.82-1.573l7-10a1 1 0 011.12-.38z" clip-rule="evenodd" />
            </svg>
            <div class="size-2 rounded-full" :class="powerBarColor"></div>
          </div>
      ...
      <!-- Power Ports Compact -->
      <div v-if="powerPortsCapacity > 0" class="tooltip tooltip-left" data-tip="Power Ports">
        <div class="flex items-center gap-2">
          <div class="flex items-center gap-1.5">
            <svg class="size-5" fill="currentColor" viewBox="0 0 20 20">
              <path fill-rule="evenodd" d="M11.3 1.046A1 1 0 0112 2v5h4a1 1 0 01.82 1.573l-7 10A1 1 0 018 18v-5H4a1 1 0 01-.82-1.573l7-10a1 1 0 011.12-.38z" clip-rule="evenodd" />
            </svg>
            <div class="size-2 rounded-full" :class="powerPortsBarColor"></div>
          </div>
      ...
      <!-- HVAC Compact -->
      <div class="tooltip tooltip-left" data-tip="HVAC">
        <div class="flex items-center gap-2">
          <div class="flex items-center gap-1.5">
            <svg class="size-5" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div class="size-2 rounded-full" :class="hvacBarColor"></div>
          </div>
      ...
      <!-- RU Compact -->
      <div class="tooltip tooltip-left" data-tip="Rack Units">
        <div class="flex items-center gap-2">
          <div class="flex items-center gap-1.5">
            <svg class="size-5" fill="currentColor" viewBox="0 0 20 20">
              <path d="M3 4a1 1 0 011-1h12a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1V4zM3 10a1 1 0 011-1h12a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1v-2zM3 16a1 1 0 011-1h12a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1v-2z" />
            </svg>
            <div class="size-2 rounded-full" :class="ruBarColor"></div>
          </div>
